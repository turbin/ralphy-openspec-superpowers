...
Convert user requirements into an OpenSpec change proposal with clear, testable acceptance criteria.
...
Summarize created files and tell the user what to run next (typically `/ralphy-implement`).
